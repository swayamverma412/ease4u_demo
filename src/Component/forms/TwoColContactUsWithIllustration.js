...
const CardContainer = tw.div`max-w-screen-xl mx-auto bg-white rounded-lg py-10 pl-10 pr-10 shadow-lg overflow-hidden`;
...
const SubmitButton = tw(PrimaryButtonBase)`inline-block lg:ml-6 mt-6 lg:mt-0 border-none`
